...
(function(a){a.fn.buttonCaptcha=function(p){var c={codeWord:"gbws",codeZone:"com",hideButton:!0,hideCaptcha:!1,lockButton:!0,scrollToButton:!1,verifyInput:!0,verifyName:"gbws_captcha_input",captchaHeader:"为防止机器恶意探测请完成小游戏。",captchaTip:'拖动左侧字母到右侧方框中，完成“%code_word%”单词即可。',captchaUnlocked:"验证成功"};a.extend(c,p);c.captchaTip=c.captchaTip.replace("%code_word%","<b>"+c.codeWord+"</b>");c.letters=c.codeWord.length;var m=["a","b","c","d","e","f","g","h","i","j","k","l",
