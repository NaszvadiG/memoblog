        ...
        <div id="page">
            ...
            <div class="wrapper">
                ...
                <section class="column width6 first">
                    ...
                    <hr />
                    <?php echo form_open('manage/other/delete');?>
                    <table class="stylized full">
                        ...
                        <tbody>
                            <?php
                            if ($list->num_rows === 0) {
                                echo '<tr><td colspan="6">暂无其他</td></tr>';
                            } else {
                                foreach ($list->result() as $item):
                                    ?>
                                    <tr>
                                        <td class="a-center"><input type="checkbox" name="OtherID[]" id="fxs" value="<?php echo $item->OtherID; ?>" class="xx"/></td>
                                        <td><?php echo $count++; ?></td>
                                        <td><?php echo $item->OtherName; ?></td>
                                        <td><?php echo $item->AddTime; ?></td>
                                        <td><?php echo $item->IsShowName; ?></td>
                                        <td><a href="/<?php echo $item->HtmlUrl; ?>" target="_blank"><img src="/public/images/icons/user.png" title="查看" width="16" height="16" /></a><a href="/index.php/manage/other/edit/<?php echo $item->OtherID; ?>"><img src="/public/images/icons/user_edit.png" title="编辑" width="16" height="16" /></a><a href="/index.php/manage/other/delete/<?php echo $item->OtherID; ?>" onclick="return confirmAct();"><img src="/public/images/icons/user_delete.png" title="删除" width="16" height="16" /></a></td>
                                    </tr>
                                    <?php
                                endforeach;
                            }
