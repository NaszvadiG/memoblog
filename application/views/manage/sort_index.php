        ...
        <div id="page">
            ...
            <div class="wrapper">
                ...
                <section class="column width6 first">
                    ...
                    <hr />
                    <?php echo form_open('manage/sort/delete');?>
                    <table class="stylized full">
                        ...
                        <tbody>
                            <?php
                            if ($list->num_rows === 0) {
                                echo '<tr><td colspan="7">暂无分类</td></tr>';
                            } else {
                                foreach ($list->result() as $item):
                                    ?>
                                    <tr>
                                        <td class="a-center"><input type="checkbox" name="fxs[]" id="fxs" value="<?php echo $item->SortID; ?>" class="xx"/></td>
                                        <td><?php echo $count++; ?></td>
                                        <td><?php echo anchor('manage/post/sort/' . $item->SortID, $item->SortName); ?></td>
                                        <td><?php echo $item->SortOrder; ?></td>
                                        <td><?php echo $item->SortLevel; ?></td>
                                        <td><?php echo ($item->IsShowID === '1') ? '正常' : '待审'; ?></td>
                                        <td><a href="/index.php/blog/sort/<?php echo $item->SortID; ?>"><img src="/public/images/icons/user.png" title="查看" width="16" height="16" /></a><a href="/index.php/manage/sort/edit/<?php echo $item->SortID; ?>"><img src="/public/images/icons/user_edit.png" title="编辑" width="16" height="16" /></a><a href="/index.php/manage/sort/delete/<?php echo $item->SortID; ?>" onclick="return confirmAct();"><img src="/public/images/icons/user_delete.png" title="删除" width="16" height="16" /></a></td>
                                    </tr>
                                    <?php
                                endforeach;
                            }
