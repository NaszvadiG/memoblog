        ...
        <div id="page">
            ...
            <div class="wrapper">
                ...
                <section class="column width6 first">
                    ...
                    <hr />
                    <?php echo form_open('manage/link/delete');?>
                    <table class="stylized full">
                        ...
                        <tbody>
                            <?php
                            if ($list->num_rows === 0) {
                                echo '<tr><td colspan="7">暂无链接</td></tr>';
                            } else {
                                foreach ($list->result() as $item):
                                    ?>
                                    <tr>
                                        <td class="a-center"><input type="checkbox" name="LinkID[]" id="fxs" value="<?php echo $item->LinkID; ?>" class="xx"/></td>
                                        <td><?php echo $count++; ?></td>
                                        <td><?php echo anchor($item->LinkUrl, $item->LinkName, 'target="_blank"'); ?></td>
                                        ...
                                        <td><a href="/index.php/manage/link/edit/<?php echo $item->LinkID; ?>"><img src="/public/images/icons/user_edit.png" title="编辑" width="16" height="16" /></a><a href="/index.php/manage/link/delete/<?php echo $item->LinkID; ?>" onclick="return confirmAct();"><img src="/public/images/icons/user_delete.png" title="删除" width="16" height="16" /></a></td>
                                    </tr>
                                    <?php
                                endforeach;
                            }
