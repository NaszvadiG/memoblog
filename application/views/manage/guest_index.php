        ...
        <div id="page">
            ...
            <div class="wrapper">
                ...
                <section class="column width6 first">
                    ...
                    <hr />
                    <?php echo form_open('manage/guest/delete');?>
                    <table class="stylized full">
                        <thead>
                            <tr>
                                <th><input type="checkbox" id="fx" /></th>
                                <th>编号</th>
                                <th width="80px">留言者</th>
                                <th>留言内容</th>
                        ...
                        <tbody>
                            <?php
                            if ($list->num_rows === 0) {
                                echo '<tr><td colspan="7">暂无留言</td></tr>';
                            } else {
                                foreach ($list->result() as $item):
                                    ?>
                                    <tr>
                                        <td class="a-center"><input type="checkbox" name="GuestID[]" id="fxs" value="<?php echo $item->GuestID; ?>" class="xx"/></td>
                                        <td><?php echo $count++; ?></td>
                                        <td><?php echo (trim($item->UserEmail) === '') ? $item->UserName : mailto($item->UserEmail, $item->UserName); ?></td>
                                        <td><?php echo $item->GuestBody; ?></td>
                                        <td><?php echo $item->AddTime; ?></td>
                                        <td><?php echo ($item->IsShowID === '0') ? '待审' : '正常'; ?></td>
                                        <td><a href="/index.php/guest/#<?php echo $item->GuestID; ?>" target="_blank"><img src="/public/images/icons/user.png" title="查看" width="16" height="16" /></a><a href="/index.php/manage/guest/edit/<?php echo $item->GuestID; ?>"><img src="/public/images/icons/user_edit.png" title="编辑" width="16" height="16" /></a><a href="/index.php/manage/guest/delete/<?php echo $item->GuestID; ?>" onclick="return confirmAct();"><img src="/public/images/icons/user_delete.png" title="删除" width="16" height="16" /></a></td>
                                    </tr>
