        ...
        <div id="page">
            ...
            <div class="wrapper">
                ...
                <section class="column width6 first">
                    ...
                    <hr />
                    <?php echo form_open('manage/isshow/delete'); ?>
                    <table class="stylized full">
                        ...
                        <tbody>
                            <?php
                            if ($list->num_rows === 0) {
                                echo '<tr><td colspan="4">暂无显示状态</td></tr>';
                            } else {
                                foreach ($list->result() as $item):
                                    ?>
                                    <tr>
                                        <td class="a-center"><input type="checkbox" name="IsShowID[]" id="fxs" value="<?php echo $item->IsShowID; ?>" class="xx"/></td>
                                        <td><?php echo $count++; ?></td>
                                        <td><?php echo $item->IsShowName; ?></td>
                                        <td><?php echo $item->IsShowOrder; ?></td>
                                        <td><a href="/index.php/manage/isshow/edit/<?php echo $item->IsShowID; ?>"><img src="/public/images/icons/user_edit.png" title="编辑" width="16" height="16" /></a><a href="/index.php/manage/isshow/delete/<?php echo $item->IsShowID; ?>" onclick="return confirmAct();"><img src="/public/images/icons/user_delete.png" title="删除" width="16" height="16" /></a></td>
                                    </tr>
                                    <?php
                                endforeach;
                            }
