        ...
        <div id="page">
            ...
            <div class="wrapper">
                ...
                <section class="column width6 first">
                    <?php echo form_open((($id = $this->uri->segment(4)) === FALSE) ? '' : 'manage/comment/update', array('id' => 'postform')); ?>
                    <fieldset>
                        <?php echo form_hidden('CommentID', $id);?>
                        <div class="clearfix leading">
                            <div class="column width3 first">
                                ...
                                <p>
                                    <label class="required">评论内容：</label><br/>
                                    <?php echo form_textarea('CommentBody', ($id === FALSE) ? '' : $post['CommentBody'], 'class="medium full" id="CommentBody"'); ?>
                                </p>
                            </div>
