...
class Kindeditor {
    ...
    public function __construct() {
        $this->save_path = FCPATH . 'uploads/' . date('yyyyMM') . '/';
        $this->save_url = base_url() . 'uploads/' . date('yyyyMM') . '/';
        $this->ext_arr = array('gif', 'jpg', 'jpeg', 'png', 'bmp', 'swf');
    ...
    public function upload($file) {
        if (empty($file) === FALSE) {
            ...
            //新文件名
            $new_file_name = date("YmdHis") . '_' . rand(99) . '.' . $file_ext;
            //移动文件
...
/* End of file kindeditor.php */
/* Location: ./application/libraries/kindeditor.php */